    ...
    <h4 class="addon-title">
        ...
        <small class="authorized-by">
            ...
            <span data-bind="if: showTokenCreateButton">
                <a href="#gitlabInputCredentials" data-toggle="modal" class="pull-right text-primary addon-auth">
                    Connect  Account
                </a>
            </span>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p>
                    ...
                    <span data-bind="ifnot: submitting">
                        <span data-bind="if: showLinkedDataset">
                            ...
                            <a data-bind="attr: {href: savedGitLabUrl()}, text: savedGitLabTitle || '' + GitLab"></a>.
                        </span>
                ...
                <div data-bind="if: showNotFound" class="text-danger">
                    The current dataset was not found on GitLab.
                </div>

                <div data-bind="if: userIsOwner">
                    <span data-bind="if: hasGitLabs">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control"
                                        data-bind="options: gitlabs,
                                                   optionsValue: 'alias',
                                                   optionsText: 'title',
                                                   value: selectedGitLabAlias,
                    ...
                    <span class="text-info" data-bind="ifnot: hasGitLabs">
                         There are no gitlabs, datasets, or files associated with the connected account.
                   </span>
